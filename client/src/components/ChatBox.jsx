...
const ChatBox = () => {
  ...
  return (
    ...
    max-md:mt-14 2xl:pr-40'>
      ...
      {/* Prompt Input Box */}
      <form onSubmit={onSubmit} className='bg-primary/20 dark:bg-[#583C79]/30 border border-primary dark:border-[#8069FF]/30 rounded-full w-full max-w-2xl p-3 pl-4 mx-auto flex gap-4 items-center'>
