...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <div className={`flex flex-col h-screen min-w-72 p-6 dark:bg-gradient-to-b from-[#242124]/30 to-[#000000]/30 border-r border-[#8069FF]/30 backdrop-blur-3xl 
      ...
      {/* New Chat Button */}
      <button onClick={createNewChat} className='flex justify-center items-center w-full py-1.5 mt-6 
      ...
      <div className='flex-1 overflow-y-scroll mt-3 text-sm space-y-3'>
        {
          chats.filter((chat) =>
            ...
            <div onClick={() => { navigate('/'); setSelectedChat(chat); setIsMenuOpen(false) }}
              key={chat._id}
              className='p-1.5 px-4 dark:bg-[#57317C]/10 border border-gray-300 dark:border-[#8069FF]/15 rounded-md cursor-pointer 
